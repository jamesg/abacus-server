    ...
    m_mime_information(new atlas::http::mimetypes())
{
    ...
    m_chronos_connection.reset(new hades::connection(options.chronos_db_file));
    chronos::db::create(*m_chronos_connection);
    ...
    boost::shared_ptr<atlas::http::router> chronos_router(new chronos::router(*m_chronos_connection));
    m_http_server.router().install(
